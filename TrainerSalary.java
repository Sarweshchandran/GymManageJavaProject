...
public class TrainerSalary extends JFrame implements ActionListener
{
	JPanel p1,p2;
	...
	TrainerSalary()
	{
		...
		l2.setBounds(56,70,80,25);
		id = new JComboBox<String>();
		id.setBounds(145,70,200,25);
		l3 = new JLabel("Month Of Salary:");
	...
	public void setvalues()
	{
		 try
	   {
		   ...
		   while(rss.next())
		   {
			   id.addItem(rss.getString("TRAINER_ID"));
		   }
	   }
	   catch(Exception e)
	   {
	...
	{
		String tid = id.getSelectedItem().toString();
		String M = month.getText();
		String A = amount.getText();
		PreparedStatement st;
		String query ="insert into TSalary (Trainer_id,Month,Amount) values (?,?,?)";
		try
		{
			...
			{
				JOptionPane.showMessageDialog(null,"Trainer Salary Added");
				this.dispose();
			}
		}
		catch(SQLException ex)
		{
			Logger.getLogger(TrainerSalary.class.getName()).log(Level.SEVERE,null,ex);
		}
	}
