...
public class UPaymentDetails extends JFrame
{
	JPanel p1,p2;
	JLabel l1;
	JTable T1;
	...
	public void updateTable()
	{
		try
		{
			...
			ResultSet rs;
			String qry = "SELECT Customer_id as 'Customer ID', Month ,Amount as 'Payment Amount Paid' FROM CFEES";
